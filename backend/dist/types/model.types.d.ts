...
export type BusinessModel = 'B2B' | 'B2C' | 'B2B2C' | 'marketplace' | 'subscription' | 'transaction-based' | 'freemium' | 'other';
...
export type AlertType = 'competitive_threat' | 'market_shift' | 'portfolio_anomaly' | 'funding_round' | 'regulatory_change' | 'custom';
...
export type RedFlagType = 'employment-gap' | 'frequent-job-changes' | 'failed-startup' | 'legal-issues' | 'reputation-concerns' | 'skill-mismatch' | 'other';
...
export type ReportType = 'deal_analysis' | 'portfolio_summary' | 'performance_tracking' | 'investment_thesis' | 'custom';
